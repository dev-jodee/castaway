    ...
    <div className="space-y-2">
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-violet-600 hover:bg-violet-500 disabled:bg-zinc-700 disabled:text-zinc-500 text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2 whitespace-nowrap"
        >
          {loading ? (
            <>
              <Spinner />
