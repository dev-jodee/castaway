...
const iconDataUri = `data:image/png;base64,${fs
  .readFileSync(path.join(process.cwd(), "public/castaway-icon.png"))
  .toString("base64")}`;
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          Solana IDL → <span style={{ color: "#7c3aed" }}>SDK Generator</span>
        </span>
        <span style={{ fontSize: "26px", color: "#a1a1aa", maxWidth: "700px" }}>
          Paste a program ID. Fetch the on-chain IDL. Download a typed client in
          TypeScript or Rust — powered by Codama.
        </span>
      </div>
